    ...
    def schedule(self, coach_time_list, member_list):
        for coach_time in coach_time_list:
            ...
            if len(available_member) == 0:
                continue
            available_member.sort(key=lambda member: member_list[member].priority, reverse=True)
            ...
            for member_number in available_member:
                if member_list[member_number].priority == member_list[available_member[0]].priority:
